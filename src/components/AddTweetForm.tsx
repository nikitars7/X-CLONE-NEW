...
import { Avatar, TextareaAutosize, IconButton, Button } from "@mui/material";
...
import { fetchAddTweet, fetchTweets, setTweets } from "../store/slices/tweets";
...
const AddTweetForm: React.FC<AddTweetFormProps> = ({ classes }) => {
  ...
  const { isAddingTweet } = useSelector(selectTweets);
            ...
            <div className={classes.addPostActions}>
              ...
              <div className={classes.addPostButton}>
                {value.length !== 0 && (
                  <div className={classes.addFormCircleProgress}>
                    ...
                    {remaining <= 20 ? (
                      <span
                        className={
                          remaining <= 0 ? classes.circularProgress : ""
                        }
                      >
                        {remaining}
                      </span>
                ...
                <Button
                  ...
                  disabled={!value || circularValue >= 100}
                  variant="contained"
                >
                  {isAddingTweet === "loading" ? (
